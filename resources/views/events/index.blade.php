...
<div class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="{{ route('events.create') }}" class="btn btn-outline-secondary me-2">New Event</a>
            ...
            <table class="table table-hover mb-0">
                ...
                @forelse($events as $event)
                    <tr>
                        ...
                        <td class="text-end">
                            <a href="{{ route('events.edit', $event) }}" class="btn btn-sm btn-outline-primary me-2">Edit</a>
                            <form action="{{ route('events.destroy', $event) }}" method="POST" class="d-inline-block" onsubmit="return confirm('Hapus event ini?');">
                                @csrf
                                @method('DELETE')
